...
<!-- FOOTER                                                      -->
<!-- ═══════════════════════════════════════════════════════════ -->
<footer class="bg-siagri-dark text-white py-10">
    <div class="max-w-6xl mx-auto px-5 flex flex-col md:flex-row items-center justify-between gap-4">
        <div class="flex items-center gap-2">
            ...
            <span class="font-bold">SiAGRI</span>
        </div>
        <p class="text-white/50 text-sm text-center">
            © 2026 SiAGRI — Sistem Informasi Agrikultur. Platform Marketplace Pertanian Lokal Mataram.
        </p>
        <div class="flex gap-5 text-sm text-white/60">
            ...
            <a href="login-page.php" class="hover:text-white transition">Login</a>
        </div>
    </div>
</footer>
